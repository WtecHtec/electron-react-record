...
const configuration: webpack.Configuration = {
  ...
  //   path.join(webpackPaths.srcRendererPath, 'countdownmask.tsx'),
  //   path.join(webpackPaths.srcRendererPath, 'record.tsx'),
  // ],
  ...
  entry: {
    ...
    countdown: [
      `webpack-dev-server/client?http://localhost:${port}/dist`,
      'webpack/hot/only-dev-server',
      path.join(webpackPaths.srcCountDownRendererPath, 'index.tsx'),
    ],
    record: [
      `webpack-dev-server/client?http://localhost:${port}/dist`,
      'webpack/hot/only-dev-server',
      path.join(webpackPaths.srcRecordRendererPath, 'index.tsx'),
    ],
    editor: [
      `webpack-dev-server/client?http://localhost:${port}/dist`,
      'webpack/hot/only-dev-server',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: path.join('countdown.html'),
